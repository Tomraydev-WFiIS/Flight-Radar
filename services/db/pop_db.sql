...
-- model
    -- Boeing
    INSERT INTO model (nazwa, producent_id, liczba_miejsc, masa) VALUES ('737-800', 1, 162, 41145);
    INSERT INTO model (nazwa, producent_id, liczba_miejsc, masa) VALUES ('787-9', 1,  250, 110000);

    -- Airbus
    INSERT INTO model (nazwa, producent_id, liczba_miejsc, masa) VALUES ('A380', 2, 555, 277000);
...
-- samolot
    -- LOT
    INSERT INTO samolot (nazwa, model_id, linia_lotnicza_id) VALUES ('SP-AAA', 2, 1);
    INSERT INTO samolot (nazwa, model_id, linia_lotnicza_id) VALUES ('SP-AAB', 2, 1);
    INSERT INTO samolot (nazwa, model_id, linia_lotnicza_id) VALUES ('SP-AAC', 2, 1);

    -- Ryanair
    INSERT INTO samolot (nazwa, model_id, linia_lotnicza_id) VALUES ('EI-AAA', 1, 2);
    INSERT INTO samolot (nazwa, model_id, linia_lotnicza_id) VALUES ('EI-AAB', 1, 2);
    INSERT INTO samolot (nazwa, model_id, linia_lotnicza_id) VALUES ('EI-AAC', 1, 2);

    -- Lufthansa
    INSERT INTO samolot (nazwa, model_id, linia_lotnicza_id) VALUES ('D-AAAA', 3, 3);
    INSERT INTO samolot (nazwa, model_id, linia_lotnicza_id) VALUES ('D-AAAB', 3, 3);
    INSERT INTO samolot (nazwa, model_id, linia_lotnicza_id) VALUES ('D-AAAC', 3, 3);

    -- China Southern
    INSERT INTO samolot (nazwa, model_id, linia_lotnicza_id) VALUES ('B-0000', 3, 4);
    INSERT INTO samolot (nazwa, model_id, linia_lotnicza_id) VALUES ('B-0001', 3, 4);
    INSERT INTO samolot (nazwa, model_id, linia_lotnicza_id) VALUES ('B-0002', 3, 4);

    -- Delta
    INSERT INTO samolot (nazwa, model_id, linia_lotnicza_id) VALUES ('N-00000', 2, 5);
    INSERT INTO samolot (nazwa, model_id, linia_lotnicza_id) VALUES ('N-00001', 2, 5);
    INSERT INTO samolot (nazwa, model_id, linia_lotnicza_id) VALUES ('N-00002', 2, 5);

    -- Emirates
    INSERT INTO samolot (nazwa, model_id, linia_lotnicza_id) VALUES ('A6-AAA', 3, 6);
    INSERT INTO samolot (nazwa, model_id, linia_lotnicza_id) VALUES ('A6-AAB', 3, 6);
    INSERT INTO samolot (nazwa, model_id, linia_lotnicza_id) VALUES ('A6-AAC', 3, 6);
...
-- lotnisko
INSERT INTO lotnisko (nazwa, kod, miasto_id) VALUES ('John Paul II International Kraków-Balice', 'KRK', 1);
INSERT INTO lotnisko (nazwa, kod, miasto_id) VALUES ('Dublin Airport', 'DUB', 2);
INSERT INTO lotnisko (nazwa, kod, miasto_id) VALUES ('Berlin Tegel Airport', 'TXL', 3);
INSERT INTO lotnisko (nazwa, kod, miasto_id) VALUES ('Beijing Daxing International Airport', 'PKX', 4);
INSERT INTO lotnisko (nazwa, kod, miasto_id) VALUES ('John F. Kennedy International Airport', 'JFK', 5);
